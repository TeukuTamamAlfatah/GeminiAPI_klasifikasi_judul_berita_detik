...
# Example usage
csv_file = 'data/april_2024_v2.csv'  # Replace with the name of your input CSV file
output_file = 'label_data/Lebel_April_2024_v2.csv'  # Name of the output CSV file
index_file = 'data/last_index_v2.txt'  # File to store the last processed index
