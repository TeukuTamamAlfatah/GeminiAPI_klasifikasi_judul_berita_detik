...
genai.configure(api_key=os.environ['GEMINI_API_KEY_FREE'])
...
def main_loop(csv_file, output_file, batch_size=3, interval=60):
    start_index = 0
    while True:
...
# Example usage
csv_file = 'data/april_2024.csv'  # Replace with the name of your input CSV file
output_file = 'data/Lebel2_April_2024.csv'  # Name of the output CSV file
...
# Start the main loop
main_loop(csv_file, output_file)
